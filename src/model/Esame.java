 ...
 * costruttore
 * metodi get / set
 * metodi di servizio (toString, equals, hasCode, [compareTo])
 * 
 * @author Antonio
 *
 */
public class Esame 
{
	 ...
	 * @param titolo nome dell'esame
	 * @param docente docente titolare dell'esame
	 */
	...
	/**
	 * Se l'esame non è ancora superato, lo conosidera superato con voto e data specificati
	 * Se l'esame è già superato, errore
